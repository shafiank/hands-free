...
// â”€â”€â”€ Preferences â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Plan Generation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export async function generateDayPlan(
    ...
    } catch { /* calendar not connected â€” continue without */ }
...
- Add breaks according to the user's preference:
  ...
  ${preferences.breakStyle === 'none' ? 'No breaks â€” plan tasks back-to-back' : ''}
- Fill gaps with regular tasks
- Leave at least 10 minutes between blocks for transitions
- Be realistic about time â€” don't overschedule
...
/** Parse "Kids pickup at 16:00" â†’ TimeBlock or null */
...
async function callLLMForPlanner(prompt: string, settings: any): Promise<string> {
    // Use agentDecide from orchestrator â€” simplest path
    try {
        ...
        // agentDecide returns { response: string } â€” not .text or .content
