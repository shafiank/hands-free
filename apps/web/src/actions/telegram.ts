...
// â”€â”€â”€ Config Management â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Sending â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Inline Keyboard Helpers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
/**
 * Answer a callback query â€” required after receiving an inline button press.
...
// â”€â”€â”€ Inbox (Telegram â†” Dashboard Bridge) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Bot Process Management â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
//   1. HANDSFREE_WEB_DIR env var  â€” set by electron/main.js to the real apps/web path
//      (necessary because in the packaged build, process.cwd() is the Next.js
//       standalone directory, not the apps/web source root)
//   2. process.cwd() â€” works correctly in development (npm run dev)
...
export async function startTelegramBot(): Promise<{ success: boolean; error?: string }> {
    try {
        ...
        const webDir = process.env.HANDSFREE_WEB_DIR || process.cwd();
        ...
        if (!fs.existsSync(botPath)) {
            console.error('[Hands Free Telegram] telegram-bot.js not found at:', botPath);
            return { success: false, error: `telegram-bot.js not found at: ${botPath}` };
        }

        // fork() uses Electron's built-in Node runtime â€” no system PATH lookup needed.
        ...
        const child = fork(botPath, [], {
            ...
            env: {
                ...
                HANDSFREE_PORT: process.env.PORT || '3000',
            },
        });
        child.unref();

        console.log('[Hands Free Telegram] Bot spawned from:', botPath);
        return { success: true };
    } catch (e: unknown) {
        const msg = e instanceof Error ? e.message : String(e);
        console.error('[Hands Free Telegram] Failed to start bot:', msg);
        return { success: false, error: msg };
    }
}
...
// â”€â”€â”€ Purge / Reset â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
