...
const HANDSFREE_STUDIO_CONFIG_FILE = path.join(DATA_DIR, 'handsfreeStudio-config.json');
...
export interface HandsFreeStudioPlan {
    techStack: string;
    files: string[];
    steps: string[];
    timeEstimate: string;
...
export interface HandsFreeStudioProject {
    id: string;
    name: string;
    prompt: string;
    plan: HandsFreeStudioPlan | null;
    steps: BuildStep[];
...
export interface HandsFreeStudioConfig {
...
const DEFAULT_HANDSFREE_STUDIO_CONFIG: HandsFreeStudioConfig = {
    ...
    livePreview: true,
    previewPort: 3001,
    projectFolder: '.handsfree-data/workspace/projects',
    maxBuildSteps: 30,
    autoRecoveryRetries: 3,
    groupChatOnErrors: true,
};

// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ Config Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬

export async function getHandsFreeStudioConfig(): Promise<HandsFreeStudioConfig> {
    ensureDirs();
    try {
        if (fs.existsSync(HANDSFREE_STUDIO_CONFIG_FILE)) {
            const raw = JSON.parse(fs.readFileSync(HANDSFREE_STUDIO_CONFIG_FILE, 'utf-8'));
            return { ...DEFAULT_HANDSFREE_STUDIO_CONFIG, ...raw };
        }
    } catch { /* fallback */ }
    return { ...DEFAULT_HANDSFREE_STUDIO_CONFIG };
}

export async function saveHandsFreeStudioConfig(config: HandsFreeStudioConfig): Promise<{ success: boolean; error?: string }> {
    try {
        ensureDirs();
        fs.writeFileSync(HANDSFREE_STUDIO_CONFIG_FILE, JSON.stringify(config, null, 2));
        return { success: true };
    } catch (e: any) {
...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ Project Management Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬

function projectFilePath(projectId: string): string {
    return path.join(PROJECTS_DIR, projectId, 'project.json');
}

export async function createProject(name: string, prompt: string): Promise<HandsFreeStudioProject> {
    ensureDirs();
    const id = `${Date.now()}-${name.toLowerCase().replace(/[^a-z0-9]/g, '-').slice(0, 30)}`;
    const projectDir = path.join(PROJECTS_DIR, id);
    fs.mkdirSync(projectDir, { recursive: true });

    const project: HandsFreeStudioProject = {
        id,
        name,
        prompt,
        plan: null,
...
export async function getProject(projectId: string): Promise<HandsFreeStudioProject | null> {
    try {
...
export async function saveProject(project: HandsFreeStudioProject): Promise<void> {
    project.updatedAt = Date.now();
    fs.writeFileSync(projectFilePath(project.id), JSON.stringify(project, null, 2));
}

export async function listProjects(): Promise<HandsFreeStudioProject[]> {
    ensureDirs();
    try {
        ...
        const projects: HandsFreeStudioProject[] = [];
        for (const d of dirs) {
            try {
...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ LLM helper (non-streaming, for planning) Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
export async function callLlmSimple(
    ...
    if (provider === 'openrouter') {
        ...
        headers['X-Title'] = 'Hands Free / Hands Free Studio';
    }
...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ Random Surprise Pool Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
