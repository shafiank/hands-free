...
export interface WhatsAppContact {
    ...
    permitted: boolean;  // User explicitly permitted Hands Free to send messages
    addedAt: number;
}

// â”€â”€â”€ Status / Connection â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export async function getWhatsAppStatus(): Promise<WhatsAppStatus> {
    ...
    try {
        ...
        // Bot not running â€” fall back to status file
    }
 ...
 * appearing â€” the bot reads the existing session and skips QR generation.
...
export async function clearWhatsAppSession(): Promise<{ success: boolean; error?: string }> {
    try {
        ...
        if (fs.existsSync(sessionPath)) {
            ...
            console.log('[Hands Free WhatsApp] Cleared stale session at:', sessionPath);
        }
        ...
        console.error('[Hands Free WhatsApp] clearWhatsAppSession failed:', msg);
...
export async function disconnectWhatsApp(): Promise<{ success: boolean; error?: string }> {
    try {
        ...
        // Bot not running â€” just clean up status file
    }
...
// â”€â”€â”€ Contacts â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Signature Config â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
const DEFAULT_SIGNATURE = 'âœ¨ Hands Free - your assistant';
...
// â”€â”€â”€ Sending â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
export async function sendWhatsAppMessage(
    ...
    try {
        const running = await isBotRunning();
        if (!running) {
            return { success: false, error: 'WhatsApp bot is not running. Start it in Settings â†’ Integrations â†’ WhatsApp.' };
        }
...
// â”€â”€â”€ WhatsApp Mode (Send Only / Read & Write) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
// â”€â”€â”€ Permitted contact lookup (used by orchestrator) â”€â”€â”€â”€â”€â”€â”€â”€â”€
