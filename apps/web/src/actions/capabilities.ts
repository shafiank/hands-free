...
/**
 * capabilities.ts Ã¢â‚¬â€ Live Capability Registry
 *
 ...
 *
 * The JSON is written to .handsfree-data/capabilities.json and is read
...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ Skill Definitions Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
const SKILL_DEFINITIONS: Record<string, SkillDef> = {
    ...
    googleCalendar: {
        ...
        description: 'Manage calendar events Ã¢â‚¬â€ list, create, update, delete.',
        available_tools: ['list_calendar_events', 'create_calendar_event', 'update_calendar_event', 'delete_calendar_event'],
        isConfigured: (s) => s.hasGoogle,
    },
    telegram: {
        name: 'Telegram Bot',
        description: 'Two-way chat via Telegram Ã¢â‚¬â€ text, voice, images, GIFs.',
    ...
    discord: {
        name: 'Discord Bot',
        description: 'Discord bot Ã¢â‚¬â€ respond to @mentions and DMs.',
    ...
    handsfree_studio: {
        name: 'Hands Free Studio Ã¢â‚¬â€ Code Builder',
        description: 'Build full software projects via Architect Ã¢â€ â€™ Reviewer Ã¢â€ â€™ Builder pipeline. Direct users to the Code page (/code).',
    ...
    browser_control: {
        ...
        description: 'Automate real Chromium browser Ã¢â‚¬â€ fill forms, scrape, screenshot.',
    ...
    // Ã¢â€â‚¬Ã¢â€â‚¬ v5 Skills Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
    autopilot: {
        name: 'Autopilot (Background Agent)',
        description: 'Autonomous background heartbeat Ã¢â‚¬â€ executes queued tasks every 5 minutes without user interaction.',
    ...
    voice_chat: {
        name: 'Voice Chat',
        description: 'Real-time voice conversation Ã¢â‚¬â€ speak to Hands Free and hear responses via browser STT/TTS.',
...
// Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬ Main Rebuild Function Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬Ã¢â€â‚¬
...
export async function rebuildCapabilities(): Promise<void> {
    try {
        ...
        const caps = {
            ...
            version_info: { handsfree: '6.0.0', capabilities: '6.0' },
            llm_providers: {
                configured: configuredProviders,
                missing_note: 'Add API keys in Settings Ã¢â€ â€™ LLM Providers',
            },
            ...
            media_capabilities: {
                vision: {
                    description: 'Analyze uploaded images Ã¢â‚¬â€ read text, recognize objects, describe scenes',
                ...
                tts: {
                    description: 'Generate voice responses Ã¢â‚¬â€ no API key required',
                    providers: {
        ...
        // Non-fatal Ã¢â‚¬â€ capabilities will be rebuilt on next toggle or restart
    }
}
