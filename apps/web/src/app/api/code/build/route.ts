...
import fs from 'fs';
import { getHandsFreeStudioConfig, getProject, saveProject, callLlmSimple } from '@/actions/code-builder';

// â”€â”€â”€ Build API â€” streams step-by-step build progress â”€â”€â”€â”€â”€â”€â”€â”€â”€

const BUILDER_SYSTEM = `You are Hands Free Studio, an expert code builder. You write complete, working code for software projects.

When given a build step instruction and the project context, respond with the EXACT file content to write.
Your response must be ONLY valid code â€” NO markdown fences, NO \`\`\`html, NO \`\`\`css, NO \`\`\`javascript, NO explanations, NO comments about what you're doing.
...
- For HTML: include <!DOCTYPE html>, <html>, <head>, <body> â€” full document
    ...
    const stream = new ReadableStream({
        async start(controller) {
            ...
            try {
                ...
                // â”€â”€ All steps done â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
${chatMessage ? `\nUser mid-build request: "${chatMessage}" â€” incorporate this change.` : ''}
