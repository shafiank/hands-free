...
// â”€â”€ Lucide icon name â†’ component map â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
/** Render a skill icon â€” Lucide component by name or emoji fallback */
...
const CATEGORIES: { value: SkillCategory; label: string; emoji: string }[] = [
    { value: 'productivity',   label: 'Productivity',   emoji: 'ðŸ“‹' },
    ...
    { value: 'security',       label: 'Security',       emoji: 'ðŸ›¡ï¸'  },
...
const GEN_MESSAGES = [
    'ðŸ“  Writing skill code...',
    'ðŸ”  Checking code structure...',
    'âš™ï¸   Running validation tests...',
    'ðŸ”„  Auto-correcting any issues...',
    'ðŸ’¾  Preparing to save...',
];

const BOILERPLATE = `// â”€â”€â”€ Hands Free Custom Skill â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
// Place this file in ~/.handsfree-data/skills/ or upload it from this page.
'use strict';
...
module.exports = {
  ...
  description: "A minimal Hands Free skill that greets the user.",
  ...
  // â”€â”€ Optional: sidebar integration â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Main function â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  /**
   * @param {object} input   - Depends on how the skill is invoked (prompt, params, etc.)
   * @param {object} context - Hands Free context: { dataDir: string, workspacePath: string, settings: object }
...
// â”€â”€â”€ Blocking Overlay â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        >
            ...
            >
                {!result ? (
                    ...
                    /* Done state â€” shown briefly before overlay closes */
...
export default function CustomSkillsPage() {
    const { t } = useTranslation();
    // â”€â”€ Skill list state â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Skill AI state â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Restore saved provider/model from localStorage â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    useEffect(() => {
        try {
            const p = localStorage.getItem('handsfree_skill_ai_provider');
            const m = localStorage.getItem('handsfree_skill_ai_model');
            if (p) setAiProvider(p);
            if (m) setAiModel(m);
        } catch { /* SSR / storage unavailable */ }
    }, []);

    // â”€â”€ Generation overlay state â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Fix state â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Install sample skills state â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    const [installingSamples, setInstallingSamples] = useState(false);

    // â”€â”€ Prevent navigation while generating/fixing â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    useEffect(() => {
    ...
    // â”€â”€ Rotate generation overlay messages â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    useEffect(() => {
    ...
    // â”€â”€ Fetch skill list â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Toggle skill â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    const handleToggle = async (id: string, current: boolean) => {
        ...
        try {
            ...
            window.dispatchEvent(new Event('handsfreeSkillsChanged'));
        } catch { /* ignore */ } finally {
            setTogglingId(null);
        }
    };

    // â”€â”€ Delete skill â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Export skill as ZIP â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    // â”€â”€ Generate skill â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    const handleGenerate = async () => {
        ...
        try {
            ...
            if (data.success) {
                ...
                if (data.warning) {
                    // Saved with errors â€” show warning, keep skill in list with error badge
                    const msg = `âš ï¸ Skill "${data.skill?.name}" saved but validation failed${attemptsStr}. Use the Fix button to auto-repair it.`;
                    setOverlayResult({ success: false, message: msg });
                    setGenResult({ success: false, message: msg });
                } else {
                    const msg = `âœ… Skill "${data.skill?.name}" generated and validated${attemptsStr}!`;
                ...
                setOverlayResult({ success: false, message: `âŒ ${msg}` });
                setGenResult({ success: false, message: msg });
            }
        } catch (e: any) {
    ...
    // â”€â”€ Fix broken skill â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    const handleFix = async (skill: CustomSkillMeta) => {
        ...
        try {
            ...
            if (data.success) {
                const attemptsStr = data.attempts > 1 ? ` (${data.attempts} attempts)` : '';
                if (data.warning) {
                    const msg = `âš ï¸ "${skill.name}" still has issues${attemptsStr}. Try a more capable model.`;
                    setFixOverlay({ success: false, message: msg });
                    setFixResult({ skillId: skill.id, success: false, message: msg });
                } else {
                    const msg = `âœ… "${skill.name}" fixed and validated${attemptsStr}!`;
                ...
                setFixOverlay({ success: false, message: `âŒ ${msg}` });
                setFixResult({ skillId: skill.id, success: false, message: msg });
            }
        } catch (e: any) {
            const msg = e.message ?? 'Network error';
    ...
    const handleUpload = async (files: FileList | null) => {
        ...
        try {
            // Send as JSON/base64 â€” avoids multipart parsing issues in Next.js standalone + Electron.
            ...
            if (data.success) {
                ...
                setUploadResult({ success: true, message: `âœ… ${installed} skill(s) installed from "${file.name}"!` });
                await fetchSkills();
                window.dispatchEvent(new Event('handsfreeSkillsChanged'));
            } else {
    ...
    // â”€â”€ Edit skill metadata â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    const handleRegenerate = async () => {
        ...
        try {
            ...
            if (data.success && data.skill) {
                // Skill was updated in-place â€” no delete needed
                await fetchSkills();
                window.dispatchEvent(new Event('handsfreeSkillsChanged'));
                setEditingSkill(null);
                setRegenPrompt('');
            ...
            setRegenError(e.message || 'Network error â€” please try again.');
        } finally {
            setRegenerating(false);
        }
    };

    // â”€â”€ Install sample skills â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    return (
        <>
            {/* â”€â”€ Generating overlay â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
            {generating && (
                <GeneratingOverlay
            ...
            {/* â”€â”€ Fix overlay â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
            {fixingId && (
                <GeneratingOverlay
                    title={t('skills.status.repairing')}
                    msgIdx={fixMsgIdx}
                    messages={[
                        'ðŸ”¬  Analyzing the broken code...',
                        'ðŸ› ï¸   Writing a fix...',
                        'ðŸ”  Validating the repaired skill...',
                        'ðŸ”„  Auto-correcting remaining issues...',
                        'ðŸ’¾  Saving the fixed skill...',
                    ]}
                    result={fixOverlay}
                />
            )}
                                    ...
                                    return (
                                        <div key={skill.id}>
                                            <div
                                                ...
                                                {/* Fix button â€” only for broken skills */}
                                                {isBroken && (
                                                    <button
                                ...
                                <div>
                                    ...
                                    <div className="flex gap-2">
                                        ...
                                        <button
                                            ...
                                            onClick={() => {
                                                try {
                                                    localStorage.setItem('handsfree_skill_ai_provider', aiProvider);
                                                    localStorage.setItem('handsfree_skill_ai_model', aiModel);
                                                    setModelSaved(true);
            ...
            {/* â”€â”€ Edit skill modal â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€ */}
            {editingSkill && (
                <div
                    className="fixed inset-0 z-50 flex items-center justify-center"
